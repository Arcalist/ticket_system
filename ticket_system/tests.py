...
class TicketsTestCase(APITestCase):
    ...
    def test_get_tickets_info(self):
        ...
        response = self.client.get(url)
        data = response.json()
        self.assertEqual(data[0], {'id': 1, 'event': 1, 'ticket_type': 'VIP', 'stock': 1000, 'price': 1000.0, 'remaining_tickets': 1000})
        self.assertEqual(data[1], {'id': 2, 'event': 1, 'ticket_type': 'Premium', 'stock': 10000, 'price': 500.0, 'remaining_tickets': 10000})
        self.assertEqual(data[2], {'id': 3, 'event': 1, 'ticket_type': 'Normal', 'stock': 40000, 'price': 100.0, 'remaining_tickets': 40000})
        self.assertEqual(data[3], {'id': 4, 'event': 2, 'ticket_type': 'Ticket1', 'stock': 5000, 'price': 200.0, 'remaining_tickets': 5000})
        self.assertEqual(data[4], {'id': 5, 'event': 2, 'ticket_type': 'Ticket2', 'stock': 5000, 'price': 200.0, 'remaining_tickets': 5000})
        self.assertEqual(data[5], {'id': 6, 'event': 3, 'ticket_type': 'Ticket', 'stock': 100000, 'price': 50.0, 'remaining_tickets': 100000})
    ...
    def test_reservation_statistics(self):
        ...
        self.assertEqual(data[0]['ticket_details'][0], {'ticket_type': 'VIP', 'sold_tickets': 0})
        self.assertEqual(data[0]['ticket_details'][1], {'ticket_type': 'Premium', 'sold_tickets': 0})
        self.assertEqual(data[0]['ticket_details'][2], {'ticket_type': 'Normal', 'sold_tickets': 0})
        self.assertEqual(data[1]['name'], 'Event 2')
        self.assertEqual(data[1]['ticket_details'][0], {'ticket_type': 'Ticket1', 'sold_tickets': 0})
        self.assertEqual(data[1]['ticket_details'][1], {'ticket_type': 'Ticket2', 'sold_tickets': 0})
        self.assertEqual(data[2]['name'], 'Event 3')
        self.assertEqual(data[2]['ticket_details'][0], {'ticket_type': 'Ticket', 'sold_tickets': 0})
    ...
    def test_reservation_info(self):
        ...
        response = self.client.get(url)
        data = response.json()
        self.assertEqual(data['payed'], False)
        ...
        response = self.client.get(url)
        data = response.json()
        self.assertEqual(data['payed'], True)